...
mm.add("(max-width:601px)",function(){
  //phone
  function locomotiveScrollTrigger() {
    gsap.registerPlugin(ScrollTrigger);
  ...
  function LoaderAnimation() {
    ...
    function FontChanger() {
      setInterval(function () {
        ...
        if (b % 2 == 0 && b <= 5) {
          now.style.transition = "opacity 0.5 ease-in-out";
          now.style.webkitTextStroke = ".5px white";
          now.style.fontFamily = "silk serif";
          now.style.color = "black";
          now.style.fontWeight = "500";
        } else if (b % 2 != 0 && b <= 5) {
    ...
    tl.from("#hero1 h4,#hero2 h4,#hero3 h2,#hero3 h3,#hero3 h4,#hero4 h4,#page2 #vidContain", {
      y: "120%",
      delay: -0.7,
      stagger: 0.1,
    });    
  ...
  function goeyEffect() {
    ...
    Shery.imageEffect(".image-div", {
      ...
      // debug:true,
      config: {"a":{"value":2,"range":[0,30]},"b":{"value":-1,"range":[-1,1]},"zindex":{"value":-9996999,"range":[-9999999,9999999]},"aspect":{"value":0.7904829623302994},"ignoreShapeAspect":{"value":true},"shapePosition":{"value":{"x":0,"y":0}},"shapeScale":{"value":{"x":0.5,"y":0.5}},"shapeEdgeSoftness":{"value":0,"range":[0,0.5]},"shapeRadius":{"value":0,"range":[0,2]},"currentScroll":{"value":0},"scrollLerp":{"value":0.07},"gooey":{"value":true},"infiniteGooey":{"value":false},"growSize":{"value":4,"range":[1,15]},"durationOut":{"value":1,"range":[0.1,5]},"durationIn":{"value":1.5,"range":[0.1,5]},"displaceAmount":{"value":0.5},"masker":{"value":false},"maskVal":{"value":1,"range":[1,5]},"scrollType":{"value":0},"geoVertex":{"range":[1,64],"value":1},"noEffectGooey":{"value":true},"onMouse":{"value":0},"noise_speed":{"value":0.23,"range":[0,10]},"metaball":{"value":0.2,"range":[0,2]},"discard_threshold":{"value":0.5,"range":[0,1]},"antialias_threshold":{"value":0,"range":[0,0.1]},"noise_height":{"value":0.5,"range":[0,2]},"noise_scale":{"value":10,"range":[0,100]}},
      gooey: true,
    });
